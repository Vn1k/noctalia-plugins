...
layout {
    center-focused-column "${centerVal}"
        ...
        Logger.i("NiriLayout", "Executing mode change to: " + targetMode)
    ...
    IpcHandler {
        ...
        function getMode() {
            return root.internalMode
        }
        
        function toggle() {
             var nextMode = (root.internalMode === "center" ? "split" : "center")
